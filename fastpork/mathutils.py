...
from math import floor, ceil, exp, log, log2, log1p, sqrt, pi
import numpy as np
...
def print_histogram(hist, *, title=None, shorttitle="",
            ...
            zeros=False, nonzerofrac=False, emptyline=True, border_style="green", rich=False):
    """
    ...
    if rich:
        rprint(
            Panel(
                hist_string,
                title=title, border_style=border_style, expand=False)
            )
    else:
        print(title)
        print(hist_string)
...
def print_histogram_tail(hist, counts, *, title=None, shorttitle="",
            average="", emptyline=True, border_style="green", rich=False):
    """
