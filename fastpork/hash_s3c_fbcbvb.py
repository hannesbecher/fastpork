...
def build_hash(universe, n, subtables, pagesize,
    ...
    rprint(
        Panel(
            f"# [bold yellow]fingerprintbits[/bold yellow]: {ffprbits} -> {fprbits}; [bold yellow]loss[/bold yellow]={fprloss:.1f} MB\n"
    ...
    get_subkey_from_page_signature = make_get_subkey_from_page_signature(
